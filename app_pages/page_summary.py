...
def summary_body():
    ...
    st.info(
        f"\n**General Information**\n"
        f"\nPowdery mildew, caused by Podosphaera clandestina, is an obligate "
        ...
        f"\nInitial symptoms of powdery mildew typically appear 7 to 10 days "
        ...
        f"\nUnlike many other fungi, powdery mildews do not require free "
        f"water for germination. However, fungal growth and germination "
        f"are favored by high humidity levels, as noted by Grove & "
        f"Boal (1991a).\n"
        f"\nThe current method of manually inspecting cherry trees for signs "
        f"of powdery mildew has been deemed time-inefficient. To address this "
